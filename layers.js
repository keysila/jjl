...
var lyr_lapangan_3 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'lapangan<br />\
    <img src="styles/legend/lapangan_3_0.png" /> <br />'
        });
var format_irigasi_4 = new ol.format.GeoJSON();
var features_irigasi_4 = format_irigasi_4.readFeatures(json_irigasi_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_irigasi_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_irigasi_4.addFeatures(features_irigasi_4);
var lyr_irigasi_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_irigasi_4, 
                style: style_irigasi_4,
                popuplayertitle: "irigasi",
                interactive: true,
                title: '<img src="styles/legend/irigasi_4.png" /> irigasi'
            });
...
var lyr_jalan_5 = new ol.layer.Vector({
    ...
    <img src="styles/legend/jalan_5_3.png" /> 8<br />\
    <img src="styles/legend/jalan_5_4.png" /> <br />'
        });
...
var lyr_Clipped_6 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Clipped<br />\
    <img src="styles/legend/Clipped_6_0.png" /> residential<br />\
    <img src="styles/legend/Clipped_6_1.png" /> service<br />\
    <img src="styles/legend/Clipped_6_2.png" /> trunk<br />\
    <img src="styles/legend/Clipped_6_3.png" /> unclassified<br />\
    <img src="styles/legend/Clipped_6_4.png" /> <br />'
        });
...
var lyr_Point_9 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Point<br />\
    <img src="styles/legend/Point_9_0.png" /> <br />\
    <img src="styles/legend/Point_9_1.png" /> bengkel<br />\
    <img src="styles/legend/Point_9_2.png" /> cf<br />\
    <img src="styles/legend/Point_9_3.png" /> instansi<br />\
    <img src="styles/legend/Point_9_4.png" /> instasi<br />\
    <img src="styles/legend/Point_9_5.png" /> kep<br />\
    <img src="styles/legend/Point_9_6.png" /> kes<br />\
    <img src="styles/legend/Point_9_7.png" /> mart<br />\
    <img src="styles/legend/Point_9_8.png" /> Mart<br />\
    <img src="styles/legend/Point_9_9.png" /> pend<br />\
    <img src="styles/legend/Point_9_10.png" /> pom<br />\
    <img src="styles/legend/Point_9_11.png" /> rm<br />\
    <img src="styles/legend/Point_9_12.png" /> tb<br />\
    <img src="styles/legend/Point_9_13.png" /> ti<br />\
    <img src="styles/legend/Point_9_14.png" /> UMKM<br />\
    <img src="styles/legend/Point_9_15.png" /> wir<br />'
        });

lyr_OpenStreetMap_0.setVisible(true);lyr_gadm41_IDNADM_ADM_4_1.setVisible(true);lyr_RW_2.setVisible(true);lyr_lapangan_3.setVisible(true);lyr_irigasi_4.setVisible(true);lyr_jalan_5.setVisible(true);lyr_Clipped_6.setVisible(true);lyr_makam_7.setVisible(true);lyr_Clipped_8.setVisible(true);lyr_Point_9.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_gadm41_IDNADM_ADM_4_1,lyr_RW_2,lyr_lapangan_3,lyr_irigasi_4,lyr_jalan_5,lyr_Clipped_6,lyr_makam_7,lyr_Clipped_8,lyr_Point_9];
...
lyr_irigasi_4.set('fieldAliases', {'id': 'id', });
lyr_jalan_5.set('fieldAliases', {'id': 'id', 'nama': 'nama', 'lebar': 'lebar', });
...
lyr_Clipped_8.set('fieldAliases', {'osm_id': 'osm_id', 'osm_type': 'osm_type', 'addr_stree': 'addr_stree', 'access_roo': 'access_roo', 'building_m': 'building_m', 'building': 'building', 'isced_leve': 'isced_leve', 'roof_mater': 'roof_mater', 'capacity': 'capacity', 'amenity': 'amenity', 'name': 'name', 'emergency': 'emergency', 'addr_house': 'addr_house', });
lyr_Point_9.set('fieldAliases', {'id': 'id', 'Kel': 'Kel', 'Nama': 'Nama', });
...
lyr_irigasi_4.set('fieldImages', {'id': 'TextEdit', });
lyr_jalan_5.set('fieldImages', {'id': 'TextEdit', 'nama': 'TextEdit', 'lebar': 'TextEdit', });
...
lyr_Clipped_8.set('fieldImages', {'osm_id': '', 'osm_type': '', 'addr_stree': '', 'access_roo': '', 'building_m': '', 'building': '', 'isced_leve': '', 'roof_mater': '', 'capacity': '', 'amenity': '', 'name': '', 'emergency': '', 'addr_house': '', });
lyr_Point_9.set('fieldImages', {'id': 'TextEdit', 'Kel': 'TextEdit', 'Nama': 'TextEdit', });
...
lyr_lapangan_3.set('fieldLabels', {'id': 'no label', 'nama': 'inline label - visible with data', });
lyr_irigasi_4.set('fieldLabels', {'id': 'no label', });
lyr_jalan_5.set('fieldLabels', {'id': 'no label', 'nama': 'inline label - visible with data', 'lebar': 'inline label - visible with data', });
...
lyr_Clipped_8.set('fieldLabels', {'osm_id': 'no label', 'osm_type': 'no label', 'addr_stree': 'no label', 'access_roo': 'no label', 'building_m': 'no label', 'building': 'no label', 'isced_leve': 'no label', 'roof_mater': 'no label', 'capacity': 'no label', 'amenity': 'no label', 'name': 'no label', 'emergency': 'no label', 'addr_house': 'no label', });
lyr_Point_9.set('fieldLabels', {'id': 'no label', 'Kel': 'no label', 'Nama': 'inline label - always visible', });
